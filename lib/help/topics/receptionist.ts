...
export const receptionistHelpTopics: HelpTopic[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'To give back unused future nights before departure, use Shorten stay (tomorrow or later). Extra already paid stays as credit — refunds are owner-only. Same-day leave is checkout, not shorten.',
      'If there is a remaining balance (folio extras), collect it now — unpaid complete-checkout is blocked.',
      'Checkout refreshes stay and extension invoices in place and puts extras on the latest (no merged cumulative bill). Room moves to Cleaning.',
    ],
    href: '/receptionist/reservations',
    hrefLabel: 'Open reservations',
    keywords: ['checkout', 'check out', 'payment', 'folio', 'departure', 'shorten stay'],
  ...
  },
  {
    ...
    steps: [
      ...
      'Extending a stay creates a unique invoice for the extra nights. The original stay invoice is not rewritten. Stay total in the collect dialog is informational.',
