...
export function RoomStatusGrid() {
  ...
  const propertyRooms = rooms.filter((r) => r.propertyId === activeProperty.id).slice(0, 16)
  ...
  return (
    <div className="surface-card p-6">
      ...
      <h3 className="relative text-lg font-semibold text-foreground mb-6">{activeProperty.name} - Room Status</h3>
