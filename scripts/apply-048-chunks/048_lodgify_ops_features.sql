-- Apply migration 048: room photos, expenses, inventory, staff chat, ops calendar
...
DROP POLICY IF EXISTS staff_conv_read ON staff_conversations;
...
DROP POLICY IF EXISTS staff_conv_update ON staff_conversations;
...
DROP POLICY IF EXISTS staff_conv_messages_read ON staff_conversation_messages;
...
DROP POLICY IF EXISTS staff_conv_messages_insert ON staff_conversation_messages;
...
DROP POLICY IF EXISTS ops_calendar_staff ON ops_calendar_events;
