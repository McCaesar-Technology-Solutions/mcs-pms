...
export const termsSections = [
  ...
  {
    title: 'Payments',
    body: `Payments are recorded manually by property staff (cash, mobile money, card, bank transfer). Invoice totals include applicable Ghana taxes (NHIL, GETFund, VAT, e-levy, and tourism levy) as configured for the property.`,
  },
  {
    title: 'Availability',
