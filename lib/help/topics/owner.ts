...
export const ownerHelpTopics: HelpTopic[] = [
  {
    ...
    steps: [
      'Dashboard — revenue KPIs, occupancy, outstanding balances, desk-payment voids, ops calendar, night audit.',
      'Reservations & Guests — same lifecycle as staff, plus discounts and full payment controls.',
      'Billing — invoices, partial payments, refunds, mistaken paid voids, WhatsApp bills.',
      ...
      'Staff — invite new people, or assign an existing manager to another of your properties (same login).',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Open Billing → find leftovers, walkouts, partials, refunds, and mistaken paid flags. Staff can void a mistaken desk payment; you are notified on this dashboard. Refunds (real money back) stay owner-only.',
      'If a stay was marked paid without collecting, open the invoice → Void mistaken desk payment. The same bill goes back to unpaid so the desk can collect. Use refund only when money actually left (Paystack).',
    ...
    href: '/owner/billing',
    hrefLabel: 'Open billing',
    keywords: ['payment', 'refund', 'void', 'invoice', 'momo', 'cash', 'whatsapp'],
  ...
  },
  {
    id: 'staff',
    title: 'Invite staff',
    summary: 'Managers, receptionists, and technicians — plus extra properties for managers.',
    steps: [
      ...
      'To put an existing manager on another of your properties, use Assign or Add existing manager. Do not send a second invite.',
      'Property chips on a manager row show where they work. Unassign is blocked if it would be their last property — assign them elsewhere first, or disable the account.',
      'They keep one login and switch which property they work from their own sidebar.',
    ...
    keywords: ['invite', 'staff', 'team', 'receptionist', 'manager', 'assign', 'property'],
